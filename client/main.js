...
/* harmony import */ var _shared_web_socket_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./shared/web-socket.service */ "./src/app/shared/web-socket.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_shared_product_service__WEBPACK_IMPORTED_MODULE_13__["ProductService"], _shared_web_socket_service__WEBPACK_IMPORTED_MODULE_14__["WebSocketService"],
...
module.exports = "<nav class=\"navbar navbar-inverse navbar-fixed-top\">\r\n  <div class=\"container\">\r\n    <div class=\"navbar-header\">\r\n      <button class=\"navbar-toggle\" type=\"button\" data-toggle=\"collapse\" data-target=\".nave-exl-collapse\">\r\n        <span class=\"icon-bar\"></span>\r\n        <span class=\"icon-bar\"></span>\r\n        <span class=\"icon-bar\"></span>\r\n      </button>\r\n      <a class=\"navbar-brand\" href=\"#\">在线竞拍</a>  \r\n    </div>\r\n    <div class=\"navbar-collapse collapse nave-exl-collapse\">\r\n      <ul class=\"navbar-nav nav\">\r\n        <li><a href=\"#\">关于我们</a></li>\r\n        <li><a href=\"#\">联系我们</a></li>\r\n        <li><a href=\"#\">网站地图</a></li>\r\n      </ul>\r\n    </div>\r\n  </div>\r\n</nav>"
...
var ProductService = /** @class */ (function () {
    ...
    ;
    ProductService.prototype.getAllCategoies = function () {
        return ["电子产品", "硬件设备", "图书"];
    };
    ProductService.prototype.getProducts = function () {
        return this.http.get("/api/products").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) { return res.json(); }));
    };
    ProductService.prototype.getProduct = function (id) {
        return this.http.get("/api/product/" + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) { return res.json(); }));
    };
    ProductService.prototype.getCommentsForProductId = function (id) {
        return this.http.get("/api/product/" + id + "/comments").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) { return res.json(); }));
    };
    ProductService.prototype.search = function (params) {
        return this.http.get("/api/products", { search: this.encodeParams(params) }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) { return res.json(); }));
    };
...
var ProductSearchParams = /** @class */ (function () {
    function ProductSearchParams(title, price, categories) {
        this.title = title;
        this.price = price;
...
var WebSocketService = /** @class */ (function () {
    ...
    WebSocketService.prototype.createObservableSocket = function (url, id) {
        ...
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (message) { return JSON.parse(message); }));
    };
...
module.exports = "<p>\r\n  <span class=\"glyphicon glyphicon-star\" *ngFor=\"let star of stars  ; let i = index\"\r\n  [class.glyphicon-star-empty]=\"star\" (click)=\"clickStar(i)\"\r\n  ></span>\r\n  <span>{{rating}}星</span>\r\n</p>\r\n"
...
module.exports = __webpack_require__(/*! C:\Users\as\Documents\vs\Auction\src\main.ts */"./src/main.ts");
